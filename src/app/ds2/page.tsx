...
import { TwitchStatusToast } from '@/components/twitch/TwitchStatusToast';
import { TwitchConnectionProvider } from '@/components/twitch/TwitchConnectionContext';

export default function DS2Page() {

    return (
        <ProgressProvider gameKey='ds2'>
                ...
                <div className="flex h-full bg-zinc-900 w-screen flex-col xl:flex-row">
                    ...
                    <div className="m-auto my-4 w-4/5 rounded-2xl xl:rounded-none xl:my-0 xl:m-0 xl:w-1/2 2xl:w-1/3 bg-zinc-800/50 border-r border-zinc-700/50 flex flex-col">
                        <div className="p-4 border-b border-zinc-700/50 flex flex-row gap-4 items-center">
                            ...
                            <TwitchChatMonitor />
                            <ProgressShareLinkGenerator gameKey='ds2' />
                        </div>
                                ...
                                <TabsContent value="maps" className="mt-2">
                                    <Card className="bg-zinc-800/50 border-zinc-700/50 backdrop-blur-sm">
                                        <CardHeader className="pb-4">
                                            <CardTitle className="text-zinc-100">Drangleic</CardTitle>
                                        </CardHeader>
                                        <CardContent>
